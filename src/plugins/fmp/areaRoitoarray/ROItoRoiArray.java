package plugins.fmp.areaRoitoarray;
...
//		Collections.sort(list, new Tools.ROI2DNameComparator());
		...
		Collections.sort(vertRoiLines, new DrosoTools.ROI2DLineLeftXComparator());
		Collections.sort(horizRoiLines, new DrosoTools.ROI2DLineLeftYComparator());
		sequence.getValue(true).removeAllROI();
