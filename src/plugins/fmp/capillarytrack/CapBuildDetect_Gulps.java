...
public class CapBuildDetect_Gulps {
	...
	private void kymosInitForGulpsDetection(SequencePlus kymographSeq, Capillarytrack parent0) {
	...
	private void getDialogBoxParametersForDetection(SequencePlus seq, boolean blevel, boolean bgulps, Capillarytrack parent0) {
		...
		if (bgulps) {
			...
			seq.transformForGulps 		= (EnumImageOp) parent0.detectPane.gulpsTab.transformForGulpsComboBox.getSelectedItem();
